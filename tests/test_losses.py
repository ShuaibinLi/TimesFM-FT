...
def test_l0_is_target_pinball_only_and_respects_masks():
...
def test_l1_adds_train_scaled_cumulative_median_huber():
    objective = ObjectiveConfig(
        name="l1",
...
def test_l2_supervises_only_explicit_selected_past_only_rows():
    objective = ObjectiveConfig(
        name="l2",
        cumulative_huber_weight=0.3,
        cumulative_horizons=(2,),
